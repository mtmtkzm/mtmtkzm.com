      ...
      <template v-if="error.statusCode === 404">
        ...
        <ArticleBody>
          ...
          <p>
            ...
            <a href="//twitter.com/mtmtkzm" target="_blank"><AppIcon name="twitter"/> Twitter</a>、もしくは
            <a href="mailto:mtmtkzm00@gmail.com"><AppIcon name="mail"/> メール</a>にてご一報いただけますと幸いです。
